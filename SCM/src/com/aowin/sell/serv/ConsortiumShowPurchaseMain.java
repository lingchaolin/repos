...
public class ConsortiumShowPurchaseMain extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MainModle> smsmList=new ConsortiumUserDao().getPomainStockSql(payType);
		request.setAttribute("smsmList", smsmList);
		request.getRequestDispatcher("pmoney/outMoney.jsp").forward(request, response);
	}
	@Override
