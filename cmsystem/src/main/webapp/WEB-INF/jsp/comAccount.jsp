        ...
        <tr>
            ...
            <table align="left" border="0">
                <tr height="30">
                    ...
                    <td width="70%"><input type="text" name="T1" size="20" value="211232132121" readonly></td>
                </tr>
                <tr height="30">
                    <td align="right">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
                    <td><input type="password" name="T2" size="20" value=""></td>
                </tr>
                <tr height="30">
                    <td align="right">&nbsp;</td>
                    <td><input type="submit" value="确定" name="B1"></td>
                </tr>
            </table>
            </form>
            </td>
        ...
        <tr>
            ...
            <table align="left" border="0">
                ...
                <tr height="30">
                    ...
                    <td><input type="text" name="T2" size="20" value="网五"></td>
                </tr>
                <tr height="30">
                    <td align="right">联系地址：</td>
                    <td><input type="text" name="T3" size="20" value="asfa asfd asf"></td>
                </tr>
                <tr height="30">
                    <td align="right">账户余额：</td>
                    <td><input type="text" name="T4" size="20" value="190.00"></td>
                </tr>
                <tr height="30">
                    <td align="right">&nbsp;</td>
