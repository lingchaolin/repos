...
<script language="javascript" type="text/javascript">
	...
	//应该是获取销售单的明细信息：但代码和入库操作很相似，复制代码，暂不修改
	function ajax_getSub(obj){
		...
		var soid=obj.innerHTML;//单号
		var httpRequest=new XMLHttpRequest;
		httpRequest.open("GET","ConsortiumShowSellSub?soid="+soid,true);
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <!--   <td width="30px" nowrap class="toolbar">&nbsp;</td>
	...
	<form action="ConsortiumShowSellMain" id="getPayTypeForm"><!--付款方式-->
		<input type="hidden" id="getPayType" name="getPayType"/>
	</form>
	<form action=ConsortiumReceipt id="getStockNoForm"><!--进行登记操作的的单号-->
...
<tr>
    ...
    <td align="center"><a onclick="inStock(this)">收款</a></td>
  </tr>
  </c:forEach>
</table>
	<br/>
