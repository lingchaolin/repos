...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  <TBODY>
  <TR>
    <TD width=173><IMG height=74 src="images/logo.gif" width=173 border=0></TD>
  ...
  <TR vAlign=top>
    <TD width=173 bgColor=#c9d3e9 rowSpan=2>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="modifyOperator.htm">更新操作员</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
    ...
    <TD height="600" bgColor=#f1f3f9>
 		<table border="0" width="100%">
 			<tr vAlign=top  height="360">
		      ...
		      <tr>
		      	<td width="5%" align="center" height="16"><input type="checkbox" name="operatorid" value="A10000001" /></td>
		        <td width="20%" align="center" height="17">Tom</td>
		        <td width="20%" align="center" height="17">张三</td>
                <td width="20%" align="center" height="17">男</td>
		        <td width="20%" align="center" height="17">是</td>
		        <td width="15%" align="center" height="17"><a href="modOperator.htm">&gt;&gt;</a></td>
		      </tr>
		      <tr>
		      	<td width="5%" align="center" height="16"><input type="checkbox" name="operatorid" value="O10000002" /></td>
		        <td width="20%" align="center" height="16">Lily</td>
		        <td width="20%" align="center" height="16">李四</td>
                <td width="20%" align="center" height="17">女</td>
		        <td width="20%" align="center" height="16">否</td>
		      ...
		      <tr>
		      	<td colSpan=6>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="删除" /></td>	
		      </tr>
    		</table>
 				</td>
 			</tr>
