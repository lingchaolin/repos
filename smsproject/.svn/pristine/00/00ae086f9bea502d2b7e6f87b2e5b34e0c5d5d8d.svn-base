  ...
  <TR vAlign=top>
    ...
    <table align="left" border="0" width="50%">
    	<tr height="30">
            ...
            <td width="70%"><input type="text" name="T2" size="20" value="张三"></td>
        </tr>
        <tr height="30">
            <td align="right">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
            <td><input type="radio" name="R1" value="V1" checked>男&nbsp;&nbsp;&nbsp; <input type="radio" name="R1" value="V2">女</td>
        </tr>
        <tr height="30">
            <td align="right">用&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;名：</td>
            <td><input type="text" name="T3" size="20" value="Tom"></td>
        </tr>
        <tr height="30">
            <td align="right">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
            <td><input type="password" name="T3" size="20" value="******"></td>
        </tr>
        <tr height="30">
            <td align="right">密&nbsp;码&nbsp;确&nbsp;认：</td>
            <td><input type="password" name="T4" size="20" value="******"></td>
        </tr>
        <tr height="30">
            <td align="right">是否管理员：</td>
            <td><input type="radio" value="V1" name="R2">是&nbsp;&nbsp;&nbsp; 
      <input type="radio" name="R2" value="V2" checked>否</td>
        </tr>
        <tr height="30">
            <td align="right">&nbsp;</td>
