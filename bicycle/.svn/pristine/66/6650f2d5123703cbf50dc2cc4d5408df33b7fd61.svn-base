...
<form action="" name="mainFrm">
    ...
    <table id="headTable" width="100%"  border="0" align="center" class="a1">
            ...
            <%--<td>--%>
                <%--<select id="customercode">--%>
                    <%--<c:forEach items="${customers}" var="c">--%>
                        <%--<option class="customercode" value="${c.customerCode}">--%>
        ...
        <tr align="justify">
            ...
            <%--<td>付款方式</td>--%>
            <%--<td>--%>
                <%--&lt;%&ndash;<input name="textfield" type="text" size="15" value="${somain.payTypeName}">&ndash;%&gt;--%>
                <%--<select id="paytype" onchange="ptchange(this)">--%>
                    <%--<option class="paytype" value="1">货到付款</option>--%>
                    <%--<option class="paytype" value="2">款到发货</option>--%>
                    <%--<option class="paytype" value="3">预付款到发货</option>--%>
                <%--</select>--%>
            <%--</td>--%>
            <td>操作人</td>
            <td><input id="userId" name="text" type="text" size="15" value="0"  onchange="check(this)"/></td>
        </tr>
