...
/*function addItem() {
	...
	oCell.innerHTML = "<select id='product'></select>";  
	...
	oCell.innerHTML = "<input type='button'  class=\"LL\" onclick=\"delItem(" + oRow.rowIndex + ")\"/>";
}
...
function delItem(index) {
	...
	for (i = index; i < rowNum; i++) {
		...
		detailTable.rows[i].cells[rowlength - 1].innerHTML =  "<input type='button'  class=\"LL\" onclick=\"delItem(" + oRow.rowIndex + ")\"/>";
	}
}*/
function hiddenDiv() {
