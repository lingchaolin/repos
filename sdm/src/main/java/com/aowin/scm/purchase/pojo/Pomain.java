package com.aowin.scm.purchase.pojo;
...
public class Pomain {
	...
	public Pomain(String venderCode, String account, String createTime, double tipFee, double productTotal,
			double poTotal, String payType, String prePayFee, int status, String remark, String stockTime,
	...
	/**
	 * @param venderCode the venderCode to set
	 */
	...
	/**
	 * @param poTotal the poTotal to set
	 */
