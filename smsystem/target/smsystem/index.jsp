            ...
            <form action="login" method=post name=login>
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr height="30">
                    ...
                    <td width="70%"><INPUT id="username" name="username" type="text" value=""></td>
                  </tr>
                  <tr height="30">
                    <td><div align="right"><strong>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:</strong></div></td>
                    <td><INPUT id="userpwd" name="userpwd" type=password value=""></td>
                  </tr>
                  <tr height="30">
                    <td>&nbsp;</td>
                    <td>&nbsp;&nbsp;&nbsp;<INPUT class=f2 type=submit size=4 value=进入系统 id="submitbutton" name="submitbutton"></td>
                  </tr>
                </table>
